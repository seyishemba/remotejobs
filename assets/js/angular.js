...
app.controller('jobListsCtr', function($scope) {
  ...
  $scope.myapplications = [
            {image : 'https://ui-avatars.com/api/?background=f2f2f2&color=000&name=fd', title : 'Front-End Developer', company : 'Tripax Travel', location: 'Berlin', type : 'Remote', date : '13, Sept. 2019' }, 
            {image : 'https://ui-avatars.com/api/?background=f2f2f2&color=000&name=cw', title : 'Creative Writer', company : 'Tripax Travel', location: 'Nairobi', type : 'Remote', date : '12, Sept. 2019' }, 
          ];
});